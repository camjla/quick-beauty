    ...
    <>
      <ScrollView>
        <View style={styles.conta}>
          ...
          <ProfileCard1 />
          <Text style={[styles.suporte, styles.conta1Typo]}>Suporte</Text>
          <View style={[styles.mdisettingsParent, styles.sair1FlexBox]}>
            ...
            <Image
              style={[
                styles.mdipersonTieIcon,
                styles.mdipersonTieIconSpaceBlock
              ]}
              contentFit="cover"
              source={require('../assets/mdipersontie.png')}
            />
          </View>
          <Image
            style={[
          ...
          />
          <Pressable
            style={styles.seTorneUmContainer}
            onPress={() => navigation.navigate('SeTorneUmProfissionalInicio')}
          >
            <Text
              style={styles.mensagens1Typo}
            >{`Se torne um profissional `}</Text>
          </Pressable>
          <Pressable
            style={[
          ...
          >
            ...
            />
            <Text style={[styles.conta1, styles.conta1Typo]}>Conta</Text>
          </Pressable>
        </View>
      </ScrollView>
