...
const SeTorneUmProfissionalRegi = () => {
  ...
  return (
    <View style={styles.seTorneUmProfissionalRegi}>
      <FormContainer4 />
      <Text style={[styles.precisamosDeAlgumas, styles.seTorneUmTypo]}>
        Precisamos de algumas informações!
      </Text>
      <FinalizarButtonContainer
        buttonText="Avançar"
        rectangleViewMarginTop={300.5}
        propMarginLeft={-27}
      ...
      <View style={styles.navbar}>
        ...
        <Text style={[styles.seTorneUm, styles.seTorneUmTypo]}>
...
export default SeTorneUmProfissionalRegi;
