...
const AdicionarEndereo = () => {
  ...
  return (
    <View style={styles.adicionarEndereo}>
      <ContainerForm
        addressCode={require("../assets/iconparksolidlocaltwo1.png")}
        addressLabel="Rua Isabela Borges, 876"
      />
      <ContainerForm
        addressCode={require("../assets/iconparksolidlocaltwo1.png")}
        addressLabel="Avenida Interlagos, 2345"
        iconParkSolidlocalTwoTop={496}
        iconParkSolidlocalTwoLeft={5}
      />
      <ContainerForm
        addressCode={require("../assets/iconparksolidlocaltwo1.png")}
        addressLabel="Rua Vergueiro, 243"
        iconParkSolidlocalTwoTop={386}
        iconParkSolidlocalTwoLeft={5}
      />
      <ContainerForm
        addressCode={require("../assets/iconparksolidlocaltwo1.png")}
        addressLabel="Avenida Santo Amaro, 123"
        iconParkSolidlocalTwoTop={331}
        iconParkSolidlocalTwoLeft={5}
      />
      <ContainerForm
        addressCode={require("../assets/iconparksolidlocaltwo1.png")}
        addressLabel="Rua Augusta, 1508"
        iconParkSolidlocalTwoTop={276}
        iconParkSolidlocalTwoLeft={5}
      />
      <ContainerForm
        addressCode={require("../assets/iconparksolidlocaltwo1.png")}
        addressLabel="Rua Ciclano Beth da Silva, 90"
        iconParkSolidlocalTwoTop={221}
        iconParkSolidlocalTwoLeft={5}
      />
      <ContainerForm
        addressCode={require("../assets/iconparksolidlocaltwo2.png")}
        addressLabel="Indique pelo mapa"
        iconParkSolidlocalTwoTop={166}
        iconParkSolidlocalTwoLeft={8}
      />
      <View style={[styles.pesquisa, styles.pesquisaLayout]}>
        <Text style={styles.digiteONome}>Digite o nome do endereço</Text>
        <View style={[styles.pesquisaChild, styles.pesquisaLayout]} />
      </View>
      <Property1Default1
      ...
      <View style={styles.navbar}>
        ...
        <Text style={styles.endereo}>Endereço</Text>
      </View>
    </View>
  );
};
